...
namespace Binance.API.Csharp.Client.Test
{
    ...
    {
        private static ApiClient apiClient = new  ApiClient("G3DZ0x8akBBj2uRA5GyiwOPFt8vJAsHbildSISnriuzOi05dxr9w4pQVMnXFwWFl", "oHF4DInapL14axha86MYoBSAvkCwHZZF7fXdtxpfxGzwRGH6ptJvZqR0SSKUsYx2");
        ...
        {
            var depositHistory = binanceClient.GetDepositHistory("cmt", DepositStatus.Success).Result;
        }

        [TestMethod]
        public void GetWithdrawHistory()
        {
            var withdrawHistory = binanceClient.GetWithdrawHistory("usdt").Result;
        }
        #endregion
